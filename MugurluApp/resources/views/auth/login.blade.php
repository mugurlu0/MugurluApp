    ...
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        ...
        <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <input name="email" id="email"
                            class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('email') is-invalid @enderror"
                            type="text" value="{{ old('email') }}" required autocomplete="email" autofocus
                    ...
                    <div class="mt-8">
                        ...
                        <input id="password" type="password"
                            class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 @error('password') is-invalid @enderror"
            ...
            <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                <span> No account yet? Click <a class="cursor-pointer text-indigo-600 hover:text-indigo-800"
                        href="{{ route('register') }}">Here</a> to register</span>
            </div>
        </div>
    </div>
</div>
<div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
    <div class=" w-6/6 mx-auto transform duration-200 hover:scale-110 cursor-pointer mr-5">

        <svg id="ea5e03e3-9574-4d13-87c6-536b7dd50c0f" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            width="832.20604" height="500.35625" viewBox="0 0 832.20604 500.35625">
            <path
            ...
            <path
                ...
                transform="translate(-183.89698 -199.82188)" fill="#6c63ff" />
            ...
            <path d="M635.92184,404.66451H999.59653V220.55582H635.92184Z" transform="translate(-183.89698 -199.82188)"
                fill="#fff" />
            ...
            <rect x="723.48425" y="141.04542" width="52" height="8.05267" fill="#6c63ff" />
            <path d="M565.897,700.13773h-381a1,1,0,1,1,0-2h381a1,1,0,0,1,0,2Z"
                transform="translate(-183.89698 -199.82188)" fill="#cbcbcb" /></svg>
    </div>
</div>
</div>
